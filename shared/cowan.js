...
(function() {
  ...
  var COMPANION_TIMEOUT = 45000; /* 45 Sekunden ohne Heartbeat = disconnected */
  ...
  function getCss() {
    return [
      ...
      '.cw-tile-active { animation:cw-tile-pulse 3s ease-in-out infinite; }',
      '.cw-tile-active:hover { border-color:rgba(34,197,94,0.7); box-shadow:0 0 30px rgba(34,197,94,0.4),0 0 60px rgba(34,197,94,0.2),0 8px 24px rgba(0,0,0,0.3),inset 0 1px 0 rgba(255,255,255,0.08); animation:none; }',
      '@keyframes cw-tile-pulse { 0%,100% { border-color:rgba(34,197,94,0.2); box-shadow:0 0 8px rgba(34,197,94,0.08),0 0 20px rgba(34,197,94,0.04),0 2px 8px rgba(0,0,0,0.2),inset 0 1px 0 rgba(255,255,255,0.05); } 50% { border-color:rgba(34,197,94,0.7); box-shadow:0 0 24px rgba(34,197,94,0.4),0 0 48px rgba(34,197,94,0.2),0 2px 8px rgba(0,0,0,0.2),inset 0 1px 0 rgba(255,255,255,0.05); } }',
