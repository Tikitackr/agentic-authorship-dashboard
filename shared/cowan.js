...
(function() {
  ...
  function getCss() {
    return [
      ...
      '.cw-tile-active { border-color:rgba(34,197,94,0.45); box-shadow:0 0 20px rgba(34,197,94,0.25),0 0 40px rgba(34,197,94,0.1),0 2px 8px rgba(0,0,0,0.2),inset 0 1px 0 rgba(255,255,255,0.05); }',
      '.cw-tile-active:hover { border-color:rgba(34,197,94,0.6); box-shadow:0 0 28px rgba(34,197,94,0.35),0 0 50px rgba(34,197,94,0.15),0 8px 24px rgba(0,0,0,0.3),inset 0 1px 0 rgba(255,255,255,0.08); }',
