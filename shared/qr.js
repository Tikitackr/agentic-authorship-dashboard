/**
 * QR Code Generator – Wrapper um qrcode-generator (Kazuhiko Arase, MIT)
 ...
 *
 * Unterstuetzt Error Correction Level M, Auto-Version (1-40).
 */
(function() {
  'use strict';

  /* ══════════════════════════════════════════════════════════════
     Eingebettete Library: qrcode-generator by Kazuhiko Arase
     https://github.com/nickymarino/qrcode-generator – MIT License
     ══════════════════════════════════════════════════════════════ */
var qrcode = function() {
...
!function() {
  ...
  /* ══════════════════════════════════════════════════════════════
     Public API – kompatibel mit bisherigem QR.toSVG(text, opts)
     ══════════════════════════════════════════════════════════════ */
  function toSVG(text, opts) {
    ...
    try {
      ...
      return '<svg xmlns="http://www.w3.org/2000/svg"><text fill="red">QR error: ' + e.message + '</text></svg>';
    }
